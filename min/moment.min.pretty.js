...
(function(e, t) {
    ...
    function q(e, t) {
        var r, i, s;
        parse = [], !t && a && (t = require("./lang/" + e));
        for (r = 0; r < f.length; r++) t[f[r]] = t[f[r]] || o.en[f[r]];
        for (r = 0; r < 12; r++) i = n([ 2e3, r ]), t.monthsShort[r] ? s = t.monthsShort[r].substring(0, 3) : s = !1, parse[r] = new RegExp("^" + (t.months[r] || t.months(i, "")) + "|^" + (s || t.monthsShort(i, "")).replace(".", "").replace(/[^A-Za-z]/, "."), "i");
        return t.monthsParse = t.monthsParse || parse, o[e] = t, t;
    }
    function R(e) {
    ...
    function W(e) {
        var t = "var a,b;return '" + e.replace(c, U) + "';", n = Function;
    ...
    function K(n, r) {
        var i = [ 0, 0, 1, 0, 0, 0, 0 ], s = {
            tzh: 0,
            tzm: 0
        }, o = r.match(c), u, a;
        for (u = 0; u < o.length; u++) {
            a = ($(o[u]).exec(n) || [])[0], n = n.replace($(o[u]), "");
            if (!J(o[u], a, i, s)) return new e(t);
        }
        return s.isPm && i[3] < 12 && (i[3] += 12), s.isPm === !1 && i[3] === 12 && (i[3] = 0), i[3] += s.tzh, i[4] += s.tzm, I(i, s.isUTC);
    }
    function Q(e, t) {
    ...
    var n, r = "1.7.0", i = Math.round, s, o = {}, u = "en", a = typeof module != "undefined" && module.exports, f = "months|monthsShort|weekdays|weekdaysShort|weekdaysMin|longDateFormat|calendar|relativeTime|ordinal|meridiem".split("|"), l = /^\/?Date\((\-?\d+)/i, c = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|YYYY|YY|a|A|hh?|HH?|mm?|ss?|SS?S?|zz?|ZZ?)/g, h = /(LT|LL?L?L?)/g, p = /(^\[)|(\\)|\]$/g, d = /([0-9a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)/gi, v = /\d\d?/, m = /\d{1,3}/, g = /\d{3}/, y = /\d{1,4}/, b = /[0-9a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/i, w = /Z|[\+\-]\d\d:?\d\d/i, E = /T/i, S = /^\s*\d{4}-\d\d-\d\d(T(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/, x = "YYYY-MM-DDTHH:mm:ssZ", T = [ [ "HH:mm:ss.S", /T\d\d:\d\d:\d\d\.\d{1,3}/ ], [ "HH:mm:ss", /T\d\d:\d\d:\d\d/ ], [ "HH:mm", /T\d\d:\d\d/ ], [ "HH", /T\d\d/ ] ], N = /([\+\-]|\d\d)/gi, C = "Month|Date|Hours|Minutes|Seconds|Milliseconds".split("|"), k = {
        Milliseconds: 1,
        Seconds: 1e3,
        Minutes: 6e4,
        Hours: 36e5,
    ...
    }, O = "DDD w M D d".split(" "), M = "M D H h m s w".split(" ");
    ...
    et("year", "FullYear"), n.duration.fn = D.prototype = {
        ...
        humanize: function(e) {
            var t = +this, n = this.lang().relativeTime, r = Z(t, !e, this.lang());
